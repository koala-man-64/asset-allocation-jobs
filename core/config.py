...
class AppSettings(BaseSettings):
    ...
    ALPHA_VANTAGE_CIRCUIT_FAILURE_THRESHOLD: int = 3
    ALPHA_VANTAGE_CIRCUIT_OPEN_SECONDS: float = 300.0
    ...
    MASSIVE_CIRCUIT_FAILURE_THRESHOLD: int = 3
    MASSIVE_CIRCUIT_OPEN_SECONDS: float = 300.0
...
def _apply_settings(new_settings: AppSettings) -> None:
    ...
    global ALPHA_VANTAGE_CIRCUIT_FAILURE_THRESHOLD
    global ALPHA_VANTAGE_CIRCUIT_OPEN_SECONDS
    ...
    global MASSIVE_CIRCUIT_FAILURE_THRESHOLD
    global MASSIVE_CIRCUIT_OPEN_SECONDS
    ...
    ALPHA_VANTAGE_CIRCUIT_FAILURE_THRESHOLD = settings.ALPHA_VANTAGE_CIRCUIT_FAILURE_THRESHOLD
    ALPHA_VANTAGE_CIRCUIT_OPEN_SECONDS = settings.ALPHA_VANTAGE_CIRCUIT_OPEN_SECONDS
    ...
    MASSIVE_CIRCUIT_FAILURE_THRESHOLD = settings.MASSIVE_CIRCUIT_FAILURE_THRESHOLD
    MASSIVE_CIRCUIT_OPEN_SECONDS = settings.MASSIVE_CIRCUIT_OPEN_SECONDS
