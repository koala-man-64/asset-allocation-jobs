...
DEFAULT_ENV_OVERRIDE_KEYS: set[str] = {
    ...
    "ALPHA_VANTAGE_CIRCUIT_FAILURE_THRESHOLD",
    "ALPHA_VANTAGE_CIRCUIT_OPEN_SECONDS",
    ...
    "ALPHA_VANTAGE_GATEWAY_CIRCUIT_OPEN_SECONDS",
    ...
    "MASSIVE_CIRCUIT_FAILURE_THRESHOLD",
    "MASSIVE_CIRCUIT_OPEN_SECONDS",
    "MASSIVE_GATEWAY_CIRCUIT_FAILURE_THRESHOLD",
    "MASSIVE_GATEWAY_CIRCUIT_OPEN_SECONDS",
    "MASSIVE_MAX_WORKERS",
    "MASSIVE_FINANCE_FRESH_DAYS",
    # Quiver gateway tuning (runtime-common gateway client).
