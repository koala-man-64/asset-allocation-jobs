...
- Scheduled runs include Massive ingestion plus Alpha Vantage dividend/split enrichment whenever the bronze market job runs. Alpha Vantage client or configuration failures are job failures, not a silent Massive-only fallback.
