...
- Discoverable control-plane bootstrap secrets such as `ASSET_ALLOCATION_API_BASE_URL` and `ASSET_ALLOCATION_API_SCOPE` are resolved from Azure when possible.
